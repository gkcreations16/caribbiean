                                     ...
                                     <div class="foot-contact">
                                         <div class="card border-0 ">
                                             <div class="row g-0 align-items-center">
                                                 ...
                                                 <div class="col-md-11 col-sm-11 col-11">
                                                     <div class="card-body">
                                                         <p class="card-title">{{ $data->address }}</p>
                                                     </div>
                                                 </div>
                                             </div>
                                         </div>
                                         <div class="card border-0 ">
                                             <div class="row g-0 align-items-center">
                                                 ...
                                                 <div class="col-md-11 col-sm-11 col-11">
                                                     <div class="card-body">
                                                         <p><a href="tel:0000000000">{{ $data->phone }}</a></p>
                                                     </div>
                                                 </div>
                                             </div>
                                         </div>
                                         ...
                                         <div class="footer-map">
                                             <iframe src=" {{ $data->phone }}" width="100%" height="100%"
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4 col-sm-6">
                                                 ...
                                                 <span>
                                                     <form>
                                                         <div class="row">
                                                             ...
                                                             <div class="col-6">
                                                                 <span><img
                                                                         src="{{ asset('assets/img/Layer-59.png') }}"
                                             ...
                                             <div class="footer-social-icon">
                                                 <ul>
                                                     <li><a href=""><span><i class="fab fa-facebook-f"></i></span></a>
                                                     </li>
                                                     <li><a href=""><span><i class="fab fa-instagram"></i></span></a>
                                                     </li>
                                                     <li><a href=""><span><i class="fab fa-twitter"></i></span></a></li>
                                                     <li><a href=""><span><i class="fab fa-twitter"></i></span></a></li>
                                                     <li><a href=""><span><i class="fab fa-linkedin-in"></i></span></a>
                                                     </li>
                                                 </ul>
                                             </div>
                                         </div>
