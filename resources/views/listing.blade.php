                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="row">
                                    @foreach ($serch_input as $search_item)
                                        @foreach ($posts as $postitem)
                                            @if ($search_item->title == $postitem->title)
                                                @if ($postitem->category == $select_cate)
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="listing-inner-info">
                                                                                <ul class="info-list mt-3">
                                                                                    ...
                                                                                    <li><span
                                                                                            class="fas fa-calendar-minus"></span>
                                                                                        {{ date('d M Y - H:i:s', $postitem->created_at->timestamp) }}
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
